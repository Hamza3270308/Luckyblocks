...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/darkdexllscript/luckyblockupdatedspawn/refs/heads/main/starskyhubluckyblockspawner"))()
